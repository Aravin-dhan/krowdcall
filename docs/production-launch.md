# KrowdCall Production Launch Guide
...
# Create database
turso db create krowdcall

# Get the connection URL
turso db show krowdcall --url
# Output: libsql://krowdcall-<your-username>.turso.io

# Create an auth token
turso db tokens create krowdcall
...
```
DATABASE_URL=libsql://krowdcall-<your-username>.turso.io
...
```bash
DATABASE_URL=libsql://krowdcall-xxx.turso.io \
DATABASE_AUTH_TOKEN=eyJhbG... \
...
EMAIL_FROM="KrowdCall <hello@yourdomain.in>"
```
...
|----------|-------|-------------|
| `DATABASE_URL` | `libsql://krowdcall-xxx.turso.io` | Production |
| `DATABASE_AUTH_TOKEN` | `eyJhbG...` | Production |
| `RESEND_API_KEY` | `re_LIVE_xxx` | Production |
| `EMAIL_FROM` | `KrowdCall <hello@yourdomain.in>` | Production |
...
Check availability: `krowdcall.in`, `krowdcall.co.in`, `krowdcall.com`
